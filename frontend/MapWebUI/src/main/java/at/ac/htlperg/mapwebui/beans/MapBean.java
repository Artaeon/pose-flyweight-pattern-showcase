...
public class MapBean implements Serializable {
    ...
    private double lat;
    private double lng;
    private LocationTypesDto locationType;
    ...
    private Marker createMarker(LocationDto location) {
        ...
        LocationTypesDto locationType = findLocationType(location.getLocationType());
    ...
    private LocationTypesDto findLocationType(String locationType) {
    ...
    public List<LocationTypesDto> getLocationTypes() {
        return locationTypes;
    }

    public void setLocationTypes(List<LocationTypesDto> locationTypes) {
